  ...
  updateUI() {
    ...
    if (footer) {
      ...
      footer.innerHTML = `
        ...
        <a href="https://wa.me/${this.WA_NUMBER}?text=${msg}" target="_blank" class="btn-gold btn-block">
...
function injectCartDrawer() {
  document.body.insertAdjacentHTML("beforeend", `
    ...
    <a href="https://wa.me/${Cart.WA_NUMBER}?text=${encodeURIComponent('Hola! Quisiera consultar sobre sus productos. 😊')}" target="_blank" class="whatsapp-fab" aria-label="WhatsApp">
